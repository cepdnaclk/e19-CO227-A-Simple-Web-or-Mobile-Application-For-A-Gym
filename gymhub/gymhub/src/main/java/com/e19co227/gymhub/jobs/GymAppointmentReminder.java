package com.e19co227.gymhub.jobs;
    ...
    public static class AppointmentReminderJob implements Job {
        ...
        private List<Member> getMembersWithNextDayAppointments() {
            ...
            try {
                ...
                connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/gymhub", "root", "");
                ...
                resultSet = statement.executeQuery("SELECT fullName, email, date " +
                        "FROM app_user, appointment JOIN appointment on app_user.userId = appointment.traineeId   WHERE appointment_date = ?");
